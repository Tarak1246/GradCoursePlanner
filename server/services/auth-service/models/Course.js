...
const courseSchema = new mongoose.Schema({
    crn: { type: Number, required: true }, // Course Reference Number (can repeat with unique semester/year combination)
    ...
    sectionCapacity: { type: Number, required: true }, // Total capacity
    sectionActual: { type: Number, required: true }, // Enrolled students
    sectionRemaining: { type: Number, required: true }, // Remaining seats
    waitlistCapacity: { type: Number, required: true }, // Waitlist capacity
    waitlistActual: { type: Number, required: true }, // Waitlisted students
    waitlistRemaining: { type: Number, required: true }, // Remaining waitlist slots
    crosslistCapacity: { type: Number, required: false }, // Crosslist capacity
    crosslistActual: { type: Number, required: false }, // Crosslist actual
    crosslistRemaining: { type: Number, required: false }, // Crosslist remaining
